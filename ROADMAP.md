...
| # | Atividade | Horas | Status | Notas |
|---|-----------|------:|--------|-------|
| 6 | Diagnóstico de lacunas de conhecimento | 8h | pendente | Identifica tópicos com mais erros no simulado → sugere historinha ou revisão SM-2 |
